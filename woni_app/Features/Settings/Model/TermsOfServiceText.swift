...
enum TermsOfServiceText {
    static let korean: [LegalClause] = [
        LegalClause(
            title: "제1조 (목적)",
            body: """
            이 약관은 이정국(이하 "운영자")가 제공하는 가계부 서비스 "Woni"(이하 "서비스")의 이용과 관련하여 \
        ...
        LegalClause(
            ...
            운영자의 서버로 전송되지 않고 이용자의 기기 내에만 저장됩니다.
        ...
        LegalClause(
            ...
            2. 서비스 이용 가능 연령은 만 14세 이상입니다. 만 14세 미만인 자는 서비스를 이용할 수 없습니다.
            3. 운영자는 다음 각 호에 해당하는 경우 이용신청을 승낙하지 않거나 사후에 이용계약을 해지할 수 \
            있습니다.
             · 만 14세 미만인 경우
        ...
        LegalClause(
            ...
            1. 운영자는 다음과 같은 서비스를 제공합니다.
             ...
             · 회원의 가계부 데이터에 대한 서버(클라우드) 동기화 기능
        ...
        LegalClause(
            ...
            4. 운영자는 이용자가 이 약관을 위반하거나 서비스의 정상적인 운영을 방해한 경우 사전 통지 후 \
        ...
        LegalClause(
            ...
            body: """
            1. 비회원이 입력한 콘텐츠는 운영자의 서버로 전송되지 않고 이용자의 기기 내에만 저장되므로, 앱 \
            삭제, 기기 초기화, 기기 분실·고장 등의 경우 복구할 수 없습니다.
...
extension TermsOfServiceText {
    static let english: [LegalClause] = [
        LegalClause(
            ...
            between Jungkuk Lee ("Developer") and users in connection with the use of "Woni," a personal \
            budgeting service ("Service") provided by the Developer.
            """
        ),
        LegalClause(
            title: "Article 2 (Definitions)",
            body: """
            1. "Service" means the Woni application provided by the Developer and all related services.
            2. "User" means any person who uses the Service under these Terms, including both Members \
            and Non-members.
            3. "Member" means a person who has entered into a service agreement with the Developer \
            ...
            a Non-member is not transmitted to the Developer's servers and is stored only on the \
            user's device.
        ...
        LegalClause(
            ...
            2. The Developer may amend these Terms to the extent that such amendment does not violate \
            applicable laws.
            3. When the Developer amends these Terms, it will announce the effective date and the \
            ...
            withdraw from membership. If the Developer has clearly stated that failure to express \
        ...
        LegalClause(
            ...
            during social login with a Google or Apple account, and the Developer accepts the \
            application.
            2. Users must be at least 14 years of age. Persons under 14 may not use the Service.
            3. The Developer may refuse an application, or terminate the agreement after acceptance, \
        ...
        LegalClause(
            ...
            body: """
            1. The Developer provides the following services:
            ...
            KRW-converted amounts
             · Server (cloud) synchronization of Members' budgeting data
            ...
            3. The Developer may modify the content of the Service and will provide advance notice of \
        ...
        LegalClause(
            ...
            2. The Developer may temporarily suspend the Service in the event of system maintenance, \
            ...
            3. The Developer may discontinue all or part of the Service for substantial reasons. In \
            such case, the Developer will notify Users at least 30 days before the discontinuation \
        ...
        LegalClause(
            ...
            2. If the Developer introduces paid services in the future, details such as product \
            composition, pricing, payment methods, and refund criteria will be announced through \
            amendment of these Terms and advance notice under Article 3. The Developer will not \
        ...
        LegalClause(
            ...
            party to do so, without the Developer's prior consent
        ...
        LegalClause(
            title: "Article 9 (Obligations of the Developer)",
            body: """
            1. The Developer shall not engage in any act prohibited by applicable laws or these Terms, \
            or contrary to public morals, and shall use its best efforts to provide the Service \
            continuously and reliably.
            2. The Developer shall maintain security systems to protect Users' personal information \
            and shall publish and comply with its Privacy Policy.
            3. Where a User's opinion or complaint is found to be justified, the Developer shall \
            address it. If processing requires an extended period, the Developer shall inform the \
        ...
        LegalClause(
            ...
            2. The Developer uses User Content solely to the extent necessary to provide the Service — \
            ...
            3. Where the Developer uses statistical information processed so that individuals cannot \
        ...
        LegalClause(
            ...
            and text included in the Service belong to the Developer.
        ...
        LegalClause(
            ...
            2. Upon completion of withdrawal, the Developer will delete the Member's account \
            information and Content stored on its servers without delay. Deleted data cannot be \
            recovered. Information that the Developer is required to retain under applicable laws \
            will be kept for the period prescribed by those laws.
            3. Upon withdrawal, data stored on the User's device is also deleted.
            4. The Developer may restrict use of the Service or terminate the service agreement, after \
        ...
        LegalClause(
            ...
            body: """
            1. Content entered by Non-members is not transmitted to the Developer's servers and is \
            stored only on the User's device. It therefore cannot be recovered if the application is \
            ...
            3. The Developer makes reasonable efforts to preserve data stored on its servers, but this \
        ...
        LegalClause(
            ...
            body: """
            1. The Developer is not liable for Service interruptions caused by natural disasters, \
            force majeure, or causes attributable to the User.
            2. The Developer does not warrant the accuracy of Content entered directly by Users and is \
            ...
            Developer does not warrant the accuracy or timeliness of exchange rate information and \
            is not liable for the results of decisions made using it.
            4. The Developer has no obligation to intervene in, and is not liable for damages arising \
            from, disputes between Users or between a User and a third party arising through the \
            Service.
            5. Nothing in this Article excludes the Developer's liability for damages caused by its \
        ...
        LegalClause(
            ...
            body: """
            1. These Terms and any dispute between the Developer and a User are governed by the laws \
            of the Republic of Korea.
            2. Any lawsuit concerning a dispute between the Developer and a User arising in connection \
